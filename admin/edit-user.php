...
// Kiểm tra nếu có ID từ query string và lấy thông tin người dùng
if (isset($_GET['id'])) {
    $id = $_GET['id'];
...
<body>
    <div class="container mt-5">
        ...
        <form action="edit-user.php?id=<?= htmlspecialchars($user['id']); ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <a href="account-user.php" class="btn btn-secondary">Quay về</a>
            </div>
        </form>
    </div>
</body>
